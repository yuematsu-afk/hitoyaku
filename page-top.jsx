      ...
      <section style={{background:'var(--bg-base)', position:'relative', overflow:'hidden'}}>
        <div style={{aspectRatio:'16/9', maxHeight:260, overflow:'hidden'}}>
          <img src="photos/hero.jpg" alt="薬剤師とのご相談"
            style={{width:'100%', height:'100%', objectFit:'cover', objectPosition:'30% 20%', display:'block'}}/>
        </div>
...
function HeroVisual({ decorative }) {
  ...
  return (
    <div style={{
      ...
      <img src="photos/hero.jpg" alt="薬剤師とのご相談"
        style={{width:'100%', height:'100%', objectFit:'cover', objectPosition:'30% top', display:'block'}}/>
...
function JourneySection() {
  ...
  const phases = [
    ...
    },
    {
      phase: 'PHASE 02',
      label: '継続的なやりとり',
      title: '相談した薬剤師と、そのまま続けられる。',
      body: '一度相談した薬剤師と、ご希望の方法でそのままやりとりを続けられます。「あの薬剤師にまた聞ける」という安心感が生まれます。',
      bg: 'var(--brand)',
      accent: '#fff',
      textColor: '#fff',
